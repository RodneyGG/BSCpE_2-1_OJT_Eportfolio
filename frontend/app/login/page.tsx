      ...
      <div style={{
        ...
        <form onSubmit={handleLogin}>
          ...
          <div style={{ textAlign: "center", marginTop: "2rem" }}>
            ...
            `}</style>
            <Link href="/" className="back-home-link" style={{ fontSize: "0.85rem", fontWeight: 600, color: "#64748b", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.4rem", transition: "color 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.color = "#0f172a"} onMouseLeave={(e) => e.currentTarget.style.color = "#64748b"}>
